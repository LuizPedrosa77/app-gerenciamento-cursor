#!/usr/bin/env python3
"""
Script para testar conexão com conta GoatFunded - versão corrigida
"""
import requests
import sys
import os
...
def test_goat_connection():
    ...
    # Dados da conta Goat - convertendo login para integer
    login = 314634315  # Como número inteiro
    ...
    try:
        ...
        deals = fetch_trade_history(
            login=str(login),  # Converter para string na chamada
